    ...
    <div class="wrapper">
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-6">
                <div class="footer-box"><img src="<?=SITE_TEMPLATE_PATH?>/images/logo.166136cd.svg" alt="logo">
                    <p>© 2020 - Mint,All Right Reserved</p>
                </div>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-6"><a class="active">
                    <div class="footer-box back-to-top">
                        <p>BACK TO TOP</p><img src="<?=SITE_TEMPLATE_PATH?>/images/arrow.a74212b6.svg" alt="arrow">
                    </div>
                </a></div>
        </div>
    </div>
...
<!-- <script src="{ccc}/js/2.e59d6546.chunk.js"></script> -->
<!-- <script src="{ccc}/js/main.ebb73d68.chunk.js"></script> -->
</body>
